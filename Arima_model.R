...
arima1 = arima(log(google_data[1:3800]), order=c(4,1,2))
summary(arima1)
...
# Here while forecasting Google stock prices from 2019 september, our model was able to capture upward trend
