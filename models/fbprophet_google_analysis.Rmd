...
## Analysis for Google Stock using Univariate (fbprophet) Model

```{r}

cat("---------- Split Date : ", as.character(split_date), " -----------------------\n")
 
file.name <- paste("prophet/", "V",latest_version, "_GOOGLE", ".RSD", sep = "")
print(file.name)
...
ggplot() +
  ...
  theme_bw() + labs(title = "Google Stock - Actual Vs Predicted", x = "Date", y= "Closing Price", subtitle = "Univariate model- Prediction for 365 days")
...
### Analysis for Google Stock using Univariate (fbprophet) Model - 2

```{r}

cat("---------- Split Date : ", as.character(split_date_2), " -----------------------\n")

file.name <- paste("prophet/", "V",latest_version, "_GOOGLE", "_2.RSD", sep = "")
print(file.name)
...
ggplot() +
  ...
  scale_color_manual(values = c("Actual_Close" = "green", "Predicted" = "blue", "Upper_Limit" = "red", "Lower_Limit" = "red")) +
 theme_bw() + labs(title = "Google Stock - Actual Vs Predicted", x = "Date", y= "Closing Price", subtitle = "Univariate model- Prediction for 35 days")
...
## Analysis for Google stock - Multivariate Model
```{r}

set.seed(1) 

file.name <- paste("prophet/", "V",latest_version, "_GOOGLE", "_MULTI.RSD", sep = "")
print(file.name)
...
ggplot() +
  ...
  scale_color_manual(values = c("Actual_Close" = "green", "Predicted" = "blue", "Upper_Limit" = "red", "Lower_Limit" = "red")) +
  theme_bw() + labs(title = "Google Stock - Actual Vs Predicted", x = "Date", y= "Closing Price", subtitle = "Multivariate model- Prediction for 365 days")
```
...
## Analysis for Google stock -  Multivariate Model -2
```{r}

set.seed(1) 

file.name <- paste("prophet/", "V",latest_version, "_GOOGLE", "_MULTI_2.RSD", sep = "")
print(file.name)
...
ggplot() +
  ...
  scale_color_manual(values = c("Actual_Close" = "green", "Predicted" = "blue", "Upper_Limit" = "red", "Lower_Limit" = "red")) +
   theme_bw() + labs(title = "Google Stock - Actual Vs Predicted", x = "Date", y= "Closing Price", subtitle = "Multivariate model- Prediction for 35 days")
```
